...
description: 算是這個博客第一篇正式開發日志. 我開了個新項目 Personal-Uptime, 基於 Wallpaper Engine 的個人運維 HUD 壁紙 - 在桌面右下角以 ASCII 終端風格展示服務器的 CPU, 内存, SSD 與運行時間. 目前是 v0.1 階段, 如果有興趣請移步 GitHub repo.…
locale: zh-cn
