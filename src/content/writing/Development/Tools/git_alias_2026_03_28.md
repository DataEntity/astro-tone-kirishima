---
title: Git 别名功能
description: 才发现.git居然有别名功能??这里记录下.因为没有专门看过 git doc 嘛 添加到.git文件contig局部修改..gitignore .gitattributes 则是项目根目录 .gitcontig 是全局配置. Linux/macOS 是 /.gitconfig，Windows 是 %USERPRO…
locale: zh-cn
