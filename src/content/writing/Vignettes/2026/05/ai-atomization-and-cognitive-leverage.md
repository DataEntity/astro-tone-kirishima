---
title: 關於個人的碎碎念
description: 靠,才發覺Ai是不是加速了個體原子化, 不過同時的放大了差異吧?? 放大已有的結構能力,也就是拓展了下限與上限, 有一部分類似工業革命時期的機械化? 或許就是吧, ai提高了個體的擴展能力,但向上還是向下, 左還是右就不一定了. 某些時候ai實際上更像是現代化進程的加速器. 工業社會時期知識的獲取與能力嵌入到組織…
locale: zh-cn
